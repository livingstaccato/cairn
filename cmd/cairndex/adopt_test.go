...
// wedge takes away cairndex's record of having written the output, leaving the
// output itself in place: every file is one cairndex wrote and none of them are
