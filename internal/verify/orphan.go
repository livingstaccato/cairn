...
//
// build.GeneratedNames is the one place that knows what cairndex writes into a
...
// it is somebody's own file reported as cairndex's litter.
//
...
// checkOrphan reports a file that wears one of cairndex's output names and that no
// manifest claims.
//
...
// way cairndex names its own could ever have been cairndex's.
//
...
// another tool owns, cairndex writes nothing there and therefore claims nothing
...
// something cairndex wrote and nothing claims it, which is exactly the question
